...
def main() -> None:
    ...
    data_path = script_dir / "leo_data.jsonl"
    adapter_out_dir = project_root / "model" / "backend" / "adapters" / "leo"
    ...
    training_args = TrainingArguments(
        output_dir=str(script_dir / "leo_training_output"),
    ...
    messages = [
        {
            "role": "user",
            "content": "Did you see anything unusual that evening?",
        }
    ]
    text = tokenizer.apply_chat_template(
